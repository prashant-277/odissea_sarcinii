...
class _Home_PageState extends State<Home_Page> with TickerProviderStateMixin {
  RangeLabels labels = RangeLabels("Day 1", "Day 280");
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.all(2.0),
                                                  child: Text(
                                                    userDetail[0]["user_data"]["week"].toString() +
                                                        " weeks & " +
                                                        userDetail[0]["user_data"]["days"].toString() +
                                                        " days",
                                                    style: TextStyle(
                                                        fontFamily: "OpenSans",
                                                        color: kblack,
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    "Your baby is " +
                                                        ...
                                                        " mm & " +
                                                        userDetail[0]["detail"]["baby_weight"].toString() +
                                                        " gm",
                                                    style: TextStyle(
                                                        fontFamily: "OpenSans",
                                                        color: kblack,
                            ...
                            Container(
                              ...
                              child: Card(
                                ...
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(10)),
                                child: Center(
                                  child: Text(userDetail[0]["user_data"]["remain_day"].toString() + " Days left",style: TextStyle(
                                      color: kblack,
                                      fontSize: 15,
                                      fontFamily: "OpenSans",
                                      fontWeight: FontWeight.w600),),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(""),
                            Text(
                              userDetail[0]["detail"]["week"].toString() +
                                  " weeks of \nPregnancy",
                              style: TextStyle(
                                  color: kblack,
                                  fontFamily: "OpenSans",
